...
| **RA-3** Risk Assessment | organizational | Agency risk assessment process; informed by the chassis POA&M and the continuous-monitor history. | [`../poam.md`](../poam.md) |
...
| **RA-7** Risk Response | implemented (via POA&M) | All identified risks land in [`../poam.md`](../poam.md) with a remediation owner and target date. |  |
