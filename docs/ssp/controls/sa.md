...
| **SA-22** Unsupported System Components | implemented (image tags pinned) | Service Dockerfiles pin major versions (`python:3.11-slim`, `nginx:1.27-alpine`, `openpolicyagent/opa:latest-rootless` — POA&M 5.4-B to pin OPA to a specific tag). |  |
